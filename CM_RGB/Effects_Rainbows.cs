...
namespace CM_RGB
{
    class Effects_Rainbows
    {

        private int frame = 0;

        [DllImport("SDKDLL.dll")]
        private static extern void SetLedColor(int row, int col, byte r, byte g, byte b);
        ...
        /// <summary>
        /// Displays the rainbow using calculated values
        /// </summary>
        public void rainbow_math()
        {
            for (int i = 0; i < 22; i++)
            {
        ...
        /// <summary>
        /// Displays the rainbow using prefdefined frames
        /// </summary>
        public void rainbow_framed()
        {
        ...
        public void rainbowVertical_framed()
        {
            switch (frame)
            {
                case 1:
